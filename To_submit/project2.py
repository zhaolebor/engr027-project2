...
def align(A, B):
    ...
    print('Please choose 3 points in each image to perform affine transformation. Points on the contour of the face work better.')
...
# blend functionality
    ...
    if mode == '1':
        ...
        # generate the angle by measuring the angle between the bottom-top line and the vertical line
        if len(points) != 4:
